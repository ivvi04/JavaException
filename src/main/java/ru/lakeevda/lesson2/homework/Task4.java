...
public class Task4 {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in))) {
            while (true) {
                ...
                try {
                    ...
                    System.out.printf("¬веденна€ строка равна: '%s'", s);
                    break;
    ...
    public static String getString(BufferedReader bufferedReader) throws IOException {
        if (bufferedReader == null) throw new NullPointerException("”казатель не может указывать на null!");
        String s = bufferedReader.readLine();
        if (s.equals("")) throw new StringEmptyException("ѕустую строку вводить нельз€!");
        return s;
    }
}
